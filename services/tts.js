...
async function synthesizeForTwilio(text, cacheKey) {
  // Return null — twilio.js will use <Say> fallback automatically
  throw new Error("Google TTS not configured — using Twilio Say fallback");
}
...
module.exports = { synthesizeForTwilio, getAudioBuffer };